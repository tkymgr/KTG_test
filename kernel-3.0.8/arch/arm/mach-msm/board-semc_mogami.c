...
static struct i2c_board_info pm8058_boardinfo[] __initdata = {
	{
		I2C_BOARD_INFO("pm8058-core", 0x00),
...
{
	gpio_set_value(SPEAKER_POWERAMP_GPIO, 1);	/* enable spkr poweramp */
	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off(void)
{
	gpio_set_value(SPEAKER_POWERAMP_GPIO, 0);	/* disable spkr poweramp */
