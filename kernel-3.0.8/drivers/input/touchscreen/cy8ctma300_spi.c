...
static long cy8ctma300_touch_ioctl(struct file *file, unsigned cmd, unsigned long arg)
{
	struct cy8ctma300_touch *tp =
...
static ssize_t cy8ctma300_bl_fw_write(struct file *filep, struct kobject *kobj,
...
static ssize_t cy8ctma300_bl_fw_read(struct file *filep, struct kobject *kobj,
	struct bin_attribute *bin_attr,
	char *buf, loff_t pos, size_t size)
{
	int count = 0;
